...
grep -q "Thor state: external_optional=8, partial=37, source_only=3, wired=7" <<<"${report}"
grep -q "Runtime: blocked=1, not_applicable=8, not_qualified=44, passed_current=2" <<<"${report}"
