...
def test_checked_in_500_set_resolves_as_selected_snapshot() -> None:
    ...
    assert snapshot.set_id == "thor-vss-3.2.1-current-lvs-rest-runtime-500"
...
def test_checked_in_current_289_set_is_explicitly_resolvable() -> None:
    snapshot = resolver.resolve_metadata_set(
        "thor-vss-3.2.1-current-lvs-rest-runtime-289"
    )
    assert snapshot.set_id == "thor-vss-3.2.1-current-lvs-rest-runtime-289"
    assert dict(snapshot.expected_counts) == {
        "capabilities": 289,
        "oracles": 289,
        "feature_families": 55,
    ...
    assert selected.set_id == "thor-vss-3.2.1-current-lvs-rest-runtime-500"
...
def test_stale_historical_descriptors_are_not_registered_as_current() -> None:
    for historical in (
        ...
        "thor-vss-3.2.1-current-synthetic-data-289",
        "thor-vss-3.2.1-current-synthetic-data-500",
        "thor-vss-3.2.1-current-mv3dt-config-utils-289",
        "thor-vss-3.2.1-current-mv3dt-config-utils-500",
        ...
        "thor-vss-3.2.1-current-spatial-ai-utils-289",
        ...
        "thor-vss-3.2.1-current-vios-webrtc-live-runtime-289",
        ...
        "thor-vss-3.2.1-current-lvs-custom-model-prompt-runtime-289",
        "thor-vss-3.2.1-current-lvs-custom-model-prompt-runtime-500",
        "thor-vss-3.2.1-current-official-edge-model-identities-runtime-289",
        "thor-vss-3.2.1-current-official-edge-model-identities-runtime-500",
        "thor-vss-3.2.1-current-rt-embed-runtime-289",
        "thor-vss-3.2.1-current-rt-embed-runtime-500",
        "thor-vss-3.2.1-current-search-content-type-runtime-289",
        "thor-vss-3.2.1-current-search-content-type-runtime-500",
    ):
