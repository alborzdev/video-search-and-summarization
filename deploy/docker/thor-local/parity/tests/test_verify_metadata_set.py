...
def test_default_selected_500_set_is_authoritatively_validated() -> None:
    ...
    assert report["set_id"] == "thor-vss-3.2.1-current-spatial-ai-utils-core-rebind-500"
...
def test_explicit_current_289_set_is_authoritatively_validated() -> None:
    ...
    assert report["set_id"] == "thor-vss-3.2.1-current-spatial-ai-utils-core-rebind-289"
