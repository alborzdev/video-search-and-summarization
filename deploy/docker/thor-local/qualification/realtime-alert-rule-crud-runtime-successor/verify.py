#!/usr/bin/env python3
"""Verify retained immutable rule-CRUD evidence and its official binding."""
...
def main() -> None:
    ...
    assert contract["official_indices"] == [329]
    assert contract["capability_id"] == "manifest-entry.realtime-alerts.01-rule-crud"
    ...
    assert lifecycle["replacement_semantics"] == "create-replacement-then-delete-old"
