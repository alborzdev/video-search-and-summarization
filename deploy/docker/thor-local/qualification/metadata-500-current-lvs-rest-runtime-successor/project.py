#!/usr/bin/env python3
"""Project the complete LVS REST-qualified 289-row prefix into 500 rows."""
...
REPO = HERE.parents[4]
PREDECESSOR = (
    HERE.parent / "metadata-500-current-lvs-mcp-runtime-successor" / "project.py"
)
SPEC = importlib.util.spec_from_file_location(
    "metadata_500_lvs_mcp_predecessor_for_lvs_rest_runtime",
    PREDECESSOR,
)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("cannot load the reviewed LVS MCP predecessor")
...
PRIOR_LEDGER_500 = (
    ...
    "metadata-500-current-lvs-mcp-runtime-successor/"
...
PRIOR_MANIFEST_500 = (
    "deploy/docker/thor-local/qualification/"
    "metadata-500-current-lvs-mcp-runtime-successor/post-state-manifest.json"
)
...
SET_ID_289 = "thor-vss-3.2.1-current-lvs-rest-runtime-289"
SET_ID_500 = "thor-vss-3.2.1-current-lvs-rest-runtime-500"
