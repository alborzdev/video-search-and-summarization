#!/usr/bin/env python3
"""Project the LVS custom-model/prompt-qualified 289-row prefix into 500 rows."""
...
PREDECESSOR = (
    HERE.parent
    / "metadata-500-current-lvs-single-request-queue-runtime-successor"
    / "project.py"
)
SPEC = importlib.util.spec_from_file_location(
    "metadata_500_lvs_single_request_predecessor_for_custom_model_prompt",
    PREDECESSOR,
)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("cannot load the reviewed LVS single-request predecessor")
...
SET_ID_289 = "thor-vss-3.2.1-current-lvs-custom-model-prompt-runtime-289"
SET_ID_500 = "thor-vss-3.2.1-current-lvs-custom-model-prompt-runtime-500"
