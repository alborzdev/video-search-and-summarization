#!/usr/bin/env python3
"""Project the current replay-qualified 289-row prefix into 500 rows."""
...
SPEC = importlib.util.spec_from_file_location(
    "metadata_500_vios_file_lifecycle_predecessor_for_webrtc_replay", PREDECESSOR
)
...
PRIOR_LEDGER_500 = (
    ...
    "metadata-500-current-nvstreamer-full-config-runtime-successor/"
...
SET_ID_289 = "thor-vss-3.2.1-current-vios-webrtc-replay-runtime-289"
SET_ID_500 = "thor-vss-3.2.1-current-vios-webrtc-replay-runtime-500"
