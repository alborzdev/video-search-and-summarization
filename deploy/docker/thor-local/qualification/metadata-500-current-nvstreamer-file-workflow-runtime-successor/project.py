#!/usr/bin/env python3
"""Project the current NvStreamer-qualified 289-row prefix into 500 rows."""
...
SPEC = importlib.util.spec_from_file_location(
    "metadata_500_vios_file_lifecycle_predecessor", PREDECESSOR
)
...
SET_ID_289 = "thor-vss-3.2.1-current-nvstreamer-file-workflow-runtime-289"
SET_ID_500 = "thor-vss-3.2.1-current-nvstreamer-file-workflow-runtime-500"
DESCRIPTOR_289 = (
