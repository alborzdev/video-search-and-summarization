...
SPEC = importlib.util.spec_from_file_location(
    "candidate_approval_mapping_successor_v2_compiler", COMPILER_PATH
)
...
def test_exact_source_lock_denominator_and_dependency_provenance(artifact):
    ...
    assert len(artifact["source_locks"]) == 11
...
def test_compiler_has_only_check_emit_and_no_action_surface():
