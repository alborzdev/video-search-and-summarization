#!/usr/bin/env python3
"""Project the LVS-format-qualified 289-row prefix into the 500-row view."""
...
REPO = HERE.parents[4]
PREDECESSOR = (
    HERE.parent / "metadata-500-current-rt-vlm-sse-runtime-successor" / "project.py"
)
SPEC = importlib.util.spec_from_file_location(
    "metadata_500_rt_vlm_sse_predecessor_for_lvs_formats",
    PREDECESSOR,
)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("cannot load the reviewed RT-VLM SSE predecessor")
...
PRIOR_LEDGER_500 = (
    ...
    "metadata-500-current-rt-vlm-sse-runtime-successor/"
...
PRIOR_MANIFEST_500 = (
    "deploy/docker/thor-local/qualification/"
    "metadata-500-current-rt-vlm-sse-runtime-successor/post-state-manifest.json"
)
...
SET_ID_289 = "thor-vss-3.2.1-current-lvs-formats-runtime-289"
SET_ID_500 = "thor-vss-3.2.1-current-lvs-formats-runtime-500"
