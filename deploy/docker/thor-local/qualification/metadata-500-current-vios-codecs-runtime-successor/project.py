...
PRIOR_LEDGER_500 = (
    ...
    "metadata-500-current-agent-evaluation-contract-successor/"
...
PRIOR_MANIFEST_500 = (
    "deploy/docker/thor-local/qualification/"
    "metadata-500-current-spatial-ai-utils-successor/post-state-manifest.json"
)
ACCEPTANCE_500 = (
    "deploy/docker/thor-local/qualification/"
...
SET_ID_289 = "thor-vss-3.2.1-current-vios-codecs-runtime-289"
SET_ID_500 = "thor-vss-3.2.1-current-vios-codecs-runtime-500"
DESCRIPTOR_289 = (
...
def _project_documents() -> tuple[dict[str, Any], ...]:
    ...
    if runtime_state_schema != {"const": "not_qualified"}:
        raise ProjectionError("predecessor CPU runtime-state schema drifted")
    runtime_state_schema.clear()
    runtime_state_schema["enum"] = ["not_qualified", "passed_current"]
