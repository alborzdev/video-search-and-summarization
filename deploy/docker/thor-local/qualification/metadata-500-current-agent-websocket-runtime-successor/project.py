#!/usr/bin/env python3
"""Project the Agent-WebSocket-qualified 289-row prefix into 500 rows."""
...
SPEC = importlib.util.spec_from_file_location(
    "metadata_500_lvs_formats_predecessor_for_agent_websocket",
    PREDECESSOR,
)
...
SET_ID_289 = "thor-vss-3.2.1-current-agent-websocket-runtime-289"
SET_ID_500 = "thor-vss-3.2.1-current-agent-websocket-runtime-500"
