...
The receipt binds to exact official Metadata500 rows 321–323 and the source-locked host/live-container implementation. Its required assertions cover:
...
- traceable scene, time, object, and media context stored separately from decision fields;
