...
The receipt binds to the exact official Metadata500 row and source-locked host/live-container implementation. Its required assertions cover:
...
- a local RT-VLM chat-completion HTTP 200 and confirmed verdict;
