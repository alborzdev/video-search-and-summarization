#!/usr/bin/env python3
"""Compile one inert, fail-closed Sparse4D candidate dependency repair."""
...
EXPECTED_SOURCE_HASHES = {
    ...
    LEDGER_PATH: "f1e63b25c607a09f19a3c53aa47d8d152c61ffbd330440b93d54eccfaa49add6",
    ...
    PREDECESSOR_MAPPING_PATH: "4bb8f3a5fba5e201b72e1f1a0f4218bff4b9a999a836c192fca44ca7e35d9cf9",
    PREDECESSOR_MAPPING_SCHEMA_PATH: "09f8610cb7f9cc1d060202f5939b7e451fd78b92f58d80d098939e5ca05b518e",
}
...
def _validate_selected_set(source: dict[str, Any]) -> None:
    ...
    if (
        ...
        or selected_row.get("descriptor_path") != DESCRIPTOR_PATH
...
def compile_repair(
    ...
    artifact: dict[str, Any] = {
        "schema_version": 1,
        "repair_id": "thor-vss-3.2.1-sparse4d-candidate-dependency-repair",
        "mode": "inert_additive_planning_overlay",
        "target": {
...
def validate_repair(artifact: dict[str, Any]) -> None:
    ...
    if EXPECTED_ARTIFACT_PAYLOAD_SHA256 not in {
        "TO_BE_PINNED",
...
def check_artifact() -> dict[str, Any]:
    ...
    if EXPECTED_ARTIFACT_RAW_SHA256 not in {"TO_BE_PINNED", observed_hash}:
