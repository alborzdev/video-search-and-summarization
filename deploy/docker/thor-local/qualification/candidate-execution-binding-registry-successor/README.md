...
PYTHONDONTWRITEBYTECODE=1 python3 \
  deploy/docker/thor-local/qualification/candidate-execution-binding-registry-successor/compiler.py \
  --check
```
...
PYTHONDONTWRITEBYTECODE=1 python3 -m pytest -q -p no:cacheprovider \
  deploy/docker/thor-local/qualification/candidate-execution-binding-registry-successor/tests
python3 -m ruff check \
  deploy/docker/thor-local/qualification/candidate-execution-binding-registry-successor
