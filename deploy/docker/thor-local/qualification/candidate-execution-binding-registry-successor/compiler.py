#!/usr/bin/env python3
"""Validate the inert 208-candidate execution-binding registry."""
...
EXPECTED_SOURCE_HASHES = {
    ...
    ADAPTER_PATH: "6e77635625a1f6b4b27dfcdc9aa5a0e695d6656adad041604f2b96fa2ac17235",
    f"{ADAPTER_DIR}/adapter.schema.json": "959727de4d57884d67202847cd968e73fd792d1811356755c197a2e34403cbbb",
    f"{ADAPTER_DIR}/compiler.py": "f58f82b18b49a527d0098ffd7c3c7313968fe90928137f5e82cd0adce99b505f",
    ...
    f"{PROTOCOL_DIR}/protocol-cases-v2-candidate.schema.json": "831d982f6912358b8dfae049cd10ed709af299d91cb7196031d28b29a092877d",
    f"{PROTOCOL_DIR}/compiler.py": "b71bfb62b74e44416510ec83677c2352d1652458a6b3cb51b60a8323094a313d",
    ...
    WAVE8_PATH: "0bf0167de20896260a7ca962665d5088385866ed6d272cf62f51d05c6c18b3f9",
    f"{WAVE8_DIR}/execution-receipt.schema.json": "f4071b29a45a5d487a241914ef7023fed39f52bc3103704f27ad76a86b3b4618",
    f"{WAVE8_DIR}/compiler.py": "39ceffbc28265401ae203d175aaa788cf41db60180a1c3816f1e57422dce0182",
...
def compile_registry() -> dict[str, Any]:
    ...
    if any(
        row["admission_grade"]
        or row["authoritative_executable_binding"]
        != {
            "action_contract_sha256": None,
            "cleanup_executor": None,
            "cleanup_rollback_contract_sha256": None,
    ...
    return {
        "registry_id": "thor-vss-3.2.1-candidate-execution-binding-registry-successor",
        "schema_version": 1,
