#!/usr/bin/env python3
"""Project the current live-WebRTC-qualified 289-row prefix into 500 rows."""
...
SPEC = importlib.util.spec_from_file_location(
    "metadata_500_vios_file_lifecycle_predecessor_for_webrtc_live", PREDECESSOR
)
...
PRIOR_LEDGER_500 = (
    ...
    "metadata-500-current-vios-webrtc-replay-runtime-successor/"
...
SET_ID_289 = "thor-vss-3.2.1-current-vios-webrtc-live-runtime-289"
SET_ID_500 = "thor-vss-3.2.1-current-vios-webrtc-live-runtime-500"
