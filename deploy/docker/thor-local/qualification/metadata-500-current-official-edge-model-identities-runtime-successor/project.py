#!/usr/bin/env python3
"""Project the official-edge-model-qualified 289-row prefix into 500 rows."""
...
PREDECESSOR = (
    HERE.parent
    / "metadata-500-current-lvs-custom-model-prompt-runtime-successor"
    / "project.py"
)
SPEC = importlib.util.spec_from_file_location(
    "metadata_500_lvs_custom_model_predecessor_for_official_edge_models",
    PREDECESSOR,
)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("cannot load the reviewed LVS custom-model predecessor")
...
SET_ID_289 = "thor-vss-3.2.1-current-official-edge-model-identities-runtime-289"
SET_ID_500 = "thor-vss-3.2.1-current-official-edge-model-identities-runtime-500"
