#!/usr/bin/env python3
"""Project the UI-Dashboard-qualified 289-row prefix into 500 rows."""
...
PREDECESSOR = (
    HERE.parent
    / "metadata-500-current-rt-embed-runtime-successor"
    / "project.py"
)
SPEC = importlib.util.spec_from_file_location(
    "metadata_500_rt_embed_predecessor_for_ui_dashboard_runtime",
    PREDECESSOR,
)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("cannot load the reviewed RT-Embed predecessor")
...
PRIOR_MANIFEST_500 = (
    "deploy/docker/thor-local/qualification/"
    "metadata-500-current-rt-embed-runtime-successor/post-state-manifest.json"
)
...
SET_ID_289 = "thor-vss-3.2.1-current-ui-dashboard-runtime-289"
SET_ID_500 = "thor-vss-3.2.1-current-ui-dashboard-runtime-500"
