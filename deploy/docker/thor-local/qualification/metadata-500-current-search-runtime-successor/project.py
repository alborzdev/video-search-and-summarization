#!/usr/bin/env python3
"""Project the Search-qualified 289-row prefix into the 500-row view."""
...
REPO = HERE.parents[4]
PREDECESSOR = (
    HERE.parent / "metadata-500-current-ui-global-chat-runtime-successor" / "project.py"
)
SPEC = importlib.util.spec_from_file_location(
    "metadata_500_ui_global_chat_predecessor_for_search_runtime",
    PREDECESSOR,
)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("cannot load the reviewed UI Global Chat predecessor")
...
PRIOR_LEDGER_500 = (
    ...
    "metadata-500-current-ui-global-chat-runtime-successor/"
...
PRIOR_MANIFEST_500 = (
    "deploy/docker/thor-local/qualification/"
    "metadata-500-current-ui-global-chat-runtime-successor/post-state-manifest.json"
)
...
SET_ID_289 = "thor-vss-3.2.1-current-search-runtime-289"
SET_ID_500 = "thor-vss-3.2.1-current-search-runtime-500"
