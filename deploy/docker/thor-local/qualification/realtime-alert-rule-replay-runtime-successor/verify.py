#!/usr/bin/env python3
"""Verify the retained Thor realtime alert replay receipt and source locks."""
...
def main() -> None:
    ...
    assert contract["official_indices"] == [330]
    assert contract["capability_id"] == "manifest-entry.realtime-alerts.02-rule-replay"
