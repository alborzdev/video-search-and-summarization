#!/usr/bin/env python3
"""Project the RT-Embed-qualified 289-row prefix into 500 rows."""
...
PREDECESSOR = (
    HERE.parent
    / "metadata-500-current-official-edge-model-identities-runtime-successor"
    / "project.py"
)
SPEC = importlib.util.spec_from_file_location(
    "metadata_500_official_edge_predecessor_for_rt_embed_runtime",
    PREDECESSOR,
)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("cannot load the reviewed official-Edge predecessor")
...
SET_ID_289 = "thor-vss-3.2.1-current-rt-embed-runtime-289"
SET_ID_500 = "thor-vss-3.2.1-current-rt-embed-runtime-500"
