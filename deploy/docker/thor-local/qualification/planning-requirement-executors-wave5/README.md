...
This isolated package starts from the exact 71 planning requirements that had
...
The canonical fourth-successor denominator is 110 total: 27
integrated/materialized and 83 live-open. Prior candidate-only Waves 3/4
selected 12 of those 83; this wave selects six of the remaining 71, leaving 65
without a candidate executor. All 83 remain live-open because this package
promotes nothing; `calibration-schema-static` is already materialized and is
not part of the open denominator.
