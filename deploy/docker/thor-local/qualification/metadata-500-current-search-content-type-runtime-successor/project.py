#!/usr/bin/env python3
"""Project the Search Content-Type-qualified 289-row prefix into 500 rows."""
...
REPO = HERE.parents[4]
PREDECESSOR = (
    HERE.parent / "metadata-500-current-search-runtime-successor" / "project.py"
)
SPEC = importlib.util.spec_from_file_location(
    "metadata_500_search_predecessor_for_content_type_runtime",
    PREDECESSOR,
)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("cannot load the reviewed Search runtime predecessor")
...
PRIOR_LEDGER_500 = (
    ...
    "metadata-500-current-search-runtime-successor/"
...
PRIOR_MANIFEST_500 = (
    "deploy/docker/thor-local/qualification/"
    "metadata-500-current-search-runtime-successor/post-state-manifest.json"
)
...
SET_ID_289 = "thor-vss-3.2.1-current-search-content-type-runtime-289"
SET_ID_500 = "thor-vss-3.2.1-current-search-content-type-runtime-500"
