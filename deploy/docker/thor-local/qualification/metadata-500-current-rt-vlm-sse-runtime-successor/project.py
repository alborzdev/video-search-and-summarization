#!/usr/bin/env python3
"""Project the RT-VLM-qualified 289-row prefix into the 500-row view."""
...
PREDECESSOR = (
    HERE.parent
    / "metadata-500-current-alert-websocket-runtime-successor"
    / "project.py"
)
SPEC = importlib.util.spec_from_file_location(
    "metadata_500_alert_websocket_predecessor_for_rt_vlm_sse",
    PREDECESSOR,
)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("cannot load the reviewed Alert-WebSocket predecessor")
...
SET_ID_289 = "thor-vss-3.2.1-current-rt-vlm-sse-runtime-289"
SET_ID_500 = "thor-vss-3.2.1-current-rt-vlm-sse-runtime-500"
