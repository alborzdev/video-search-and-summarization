#!/usr/bin/env python3
"""Project the LVS MCP-qualified 289-row prefix into the 500-row view."""
...
PREDECESSOR = (
    HERE.parent
    / "metadata-500-current-search-content-type-runtime-successor"
    / "project.py"
)
SPEC = importlib.util.spec_from_file_location(
    "metadata_500_search_content_type_predecessor_for_lvs_mcp_runtime",
    PREDECESSOR,
)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("cannot load the reviewed Search Content-Type predecessor")
...
SET_ID_289 = "thor-vss-3.2.1-current-lvs-mcp-runtime-289"
SET_ID_500 = "thor-vss-3.2.1-current-lvs-mcp-runtime-500"
